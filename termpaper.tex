...
Oracle releases their
implementation of the compiler and the virtual machine under the GNU General
Public License, which means that they can be redistributed or modified as long
as the source code is distributed as well.
